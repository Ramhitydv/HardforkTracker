// src/lib.rs
/*
 * Core library for HardforkTracker
 */
...
#[derive(Debug)]
pub struct HardforkTrackerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HardforkTrackerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HardforkTracker processing");
    
    let mut processor = HardforkTrackerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HardforkTrackerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HardforkTrackerProcessor::new(false);
